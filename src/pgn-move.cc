...
namespace board
{
    ...
    const Position PgnMove::start_get()
    {
        return start_;
    }

    const Position PgnMove::end_get()
    {
        return end_;
    }

    PieceType PgnMove::piece_get()
    {
        return piece_;
    }

    PgnMove::opt_piece_t PgnMove::promotion_get()
    {
        return promotion_;
    }

    bool PgnMove::capture_get()
    {
        return capture_;
    }

    ReportType PgnMove::report_get()
    {
        return report_;
    }
